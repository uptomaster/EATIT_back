			      ...
			      <c:forEach var="myorder" items="${ingrebuylist}">
					  <div class="ingredientpurchase_page_list">
					    ...
					    <div class="ingredientpurchase_review_list">
					      <a href="${pageContext.request.contextPath}/userMyPage/writeReview.my?ordersNumber=${myorder.ordersNumber}" class="ingredientpurchase_review_meal review_button" data-orders-number="${myorder.ordersNumber}" data-member-number="${memberNumber}">리뷰</a>
					    </div>
					  </div>
				  </c:forEach>
			  </c:otherwise>
