  ...
  <main>
    <div class="container"> <!-- 1100px 영역 -->
      <div class="content_container"> <!-- 컨텐츠 영역 -->
        ...
        <!-- 아이디 찾기 입력 폼 -->
        <form action="${pageContext.request.contextPath}/findId/findIdOk.fi" method="post" class="findIdAuth_input_form" data-found-id="<c:out value='${foundId}'/>" data-context-path="${pageContext.request.contextPath}" novalidate>
          <!-- 아이디찾기 입력칸 제목 -->
