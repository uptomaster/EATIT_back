    ...
    <div class="wrap">
        ...
        <div class="buy_food">
          ...
          <div id="buy_food_section">
            <div class="buy_food_menu_list">
              <img src="./../../assets/img/carrot.jpg" alt="메뉴 이미지">
              <div class="buy_each_container">
                <p class="buy_food_stock">재고 2개</p>
                <p class="buy_food_menu_name">당근</p>
            ...
            <div class="buy_food_menu_list">
              <img src="./../../assets/img/onion.jpg" alt="메뉴 이미지">
              <div class="buy_each_container">
                <p class="buy_food_stock">재고 3개</p>
                <p class="buy_food_menu_name">양파</p>
                <div class="buy_food_stock_choice">
                  <a href="#" class="minus">-</a>
                  <p class="count">1</p>
                  <a href="#" class="plus">+</a>
            ...
            <div class="buy_food_menu_list">
              ...
              <div class="buy_each_container">
                <p class="buy_food_stock">재고 3개</p>
                <p class="buy_food_menu_name">오이</p>
                <div class="buy_food_stock_choice">
                  <a href="#" class="minus">-</a>
                  <p class="count">1</p>
                  <a href="#" class="plus">+</a>
      ...
      <div class="buy_map_area">
        <div class="buy_back_store_list">
          <a href="./ingredientList.html">재료목록으로 돌아가기</a>
        </div>
