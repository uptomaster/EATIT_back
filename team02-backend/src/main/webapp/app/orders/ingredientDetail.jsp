        ...
        <div class="buy_left_area">
            ...
            <div class="buy_food">
                <ul class="buy_food_menu_choice">
                    <li><a href="${pageContext.request.contextPath}/orders/storeDetail.or?itemNumber=${item.itemNumber}">음식</a></li>
                    <li><a class="active" href="${pageContext.request.contextPath}/orders/ingredientDetail.or?itemNumber=${item.itemNumber}">재료</a></li>
                </ul>
                ...
                <div id="buy_food_section">
                    <c:choose>
                        <c:when test="${empty ingredientList}">
                            <p class="no-items">판매중인 재료가 없습니다.</p>
                        </c:when>
                        <c:otherwise>
                            <c:forEach var="p" items="${ingredientList}">
                ...
                <div class="pagination">
                    <c:forEach var="i" begin="1" end="${maxPage}">
                        <a href="${pageContext.request.contextPath}/orders/ingredientDetail.or?itemNumber=${item.itemNumber}&page=${i}" class="${i == page ? 'active' : ''}">${i}</a>
                    </c:forEach>
                </div>
            </div>
        </div>
