            ...
            <div class="buy_left_area">
                ...
                <div class="buy_store_info">
                    <div class="store_image_wrapper">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <img src="${pageContext.request.contextPath}/assets/img/food3.jpg" alt="기본 이미지">
                            </c:otherwise>
                        </c:choose>
                        <!-- 찜 버튼 -->
                ...
                <div class="buy_food">
                    <ul class="buy_food_menu_choice">
                        <li><a href="${pageContext.request.contextPath}/orders/storeDetail.or?itemNumber=${item.itemNumber}&tab=FOOD">음식</a></li>
                        <li><a class="active"
                                ...
                                <c:forEach var="p" items="${ingredientList}">
                                    <div class="buy_food_menu_list">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <img src="${pageContext.request.contextPath}/assets/img/food4.jpg" alt="기본 이미지">
                                            </c:otherwise>
                                        </c:choose>
                    ...
                    <div class="pagination">
                        <c:forEach var="i" begin="1" end="${maxPage}">
                            <a href="${pageContext.request.contextPath}/orders/ingredientDetail.or?itemNumber=${item.itemNumber}&page=${i}"
