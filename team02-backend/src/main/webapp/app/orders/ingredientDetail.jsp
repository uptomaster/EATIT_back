				...
				<div class="buy_store_info">
					<div class="store_image_wrapper">
						<c:choose>
							...
							<c:otherwise>
								<img
									src="${pageContext.request.contextPath}/assets/img/food3.jpg"
									alt="기본 이미지">
							</c:otherwise>
						</c:choose>
				...
				<div class="buy_food">
									...
									<div class="buy_food_menu_list">
										<div class="food_img_wrapper">
											<c:choose>
												...
												<c:otherwise>
													<img
														src="${pageContext.request.contextPath}/assets/img/food4.jpg"
														alt="기본 이미지">
												</c:otherwise>
											</c:choose>
					...
					<div class="pagination" id="pagination">
						<c:forEach var="i" begin="1" end="${maxPage}">
							<a
								href="${pageContext.request.contextPath}/orders/ingredientDetail.or?itemNumber=${item.itemNumber}&page=${i}&tab=${param.tab}"
