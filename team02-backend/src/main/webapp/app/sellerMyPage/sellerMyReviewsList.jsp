    ...
    <div class="seller_reviewList_menu">
      ...
      <ul class="seller_reviewList_menu_list">
        ...
        <li><a href="${pageContext.request.contextPath}/sellerMyPage/selleringredientPurchaseList.se">재료 구매 내역</a></li>
				...
				<li class="seller_reviewList_menu_list_current"><a href="${pageContext.request.contextPath}/sellerMyPage/myReviews.se">내 리뷰 관리</a></li>
      ...
      <div class="pagination">
        <ul class="pagination_ul">
          <c:if test="${prev}">
            <li><a
              href="${pageContext.request.contextPath}/sellerMyPage/myReviews.se?page=${startPage - 1}"
              class="prev">&lt;</a></li>
          </c:if>
            ...
            <c:choose>
              <c:when test="${!(i == page) }">
                <li><a class="pagination_item"
                  href="${pageContext.request.contextPath}/sellerMyPage/myReviews.se?page=${i}">
                    <c:out value="${i}" />
                </a></li>
              </c:when>
              <c:otherwise>
          ...
          <c:if test="${next}">
            <li><a
              href="${pageContext.request.contextPath}/sellerMyPage/myReviews.se?page=${endPage + 1}"
              class="next">&gt;</a>
          </c:if>
        </ul>
      </div>
