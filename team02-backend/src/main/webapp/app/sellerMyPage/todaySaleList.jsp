  ...
  <main>
    ...
    <div class="today_sell_menu">
      ...
      <ul class="today_sell_menu_list">
        ...
        <li class="today_sell_menu_list_current"><a href="${pageContext.request.contextPath}/sellerMyPage/todaySaleList.se">판매 내역</a></li>
			</ul>
    </div>
    ...
    <div class="today_sell_page"> <!-- 1100 영역-->
      ...
      <!-- 총/오늘 판매내역 선택  -->
       <!-- 탭 -->
	    <div class="tabs">
	      <a href="${pageContext.request.contextPath}/sellerMyPage/todaySaleList.se" class="active">오늘 판매</a>
