...
<body>
	...
	<main>
		...
		<div class="store_info_menu">
			...
			<ul class="store_info_menu_list">
				...
				<li class="store_info_menu_list_current"><a
					href="${pageContext.request.contextPath}/sellerMyPage/storeInfo.se">사업장관리</a>
				</li>
				<li><a
        ...
        <div class="store_info_store_info">
          <img id="storeImage" src="${pageContext.request.contextPath}/assets/img/store.jpg" alt="가게 이미지 추가하기">
          <div class="store_info_store_info_detail">
            <p class="store_info_store_name"><c:out value="${sellerInfo.sellerName}" /></p>
            <p class="store_info_store_address"><c:out value="${sellerInfo.storeAddressDetail}" /></p>
            <p class="store_info_store_open_time">
              <c:out value="${sellerInfo.storeOpenTime}" /> ~ <c:out value="${sellerInfo.storeCloseTime}" />
            </p>
          </div>
        ...
        <!-- ✅ 가게 정보 끝 --> --%>
          ...
          <ul>
            ...
            <li class="${tab eq 'ingredient' ? 'active' : ''}">
				...
				<div class="store_info_ingredient">
					<ul>
						...
						<li class="store_info_ingredient_menu_choice"><a
							href="${pageContext.request.contextPath}/app/sellerMyPage/ingredientSalesWrite.jsp"><div>새
									메뉴 등록</div></a></li>
					</ul>
									...
									<div class="store_info_ingredient_menu_list">
										...
										<div class="store_info_ingredient_menu_info_stock">
											<div class="store_info_btns">
												...
												<button type="button" class="store_info_ingredient_edit_btn"
													data-ing-itemNumber="${ing.itemNumber}"
													href="${pageContext.request.contextPath}/sellerMyPage/editIngredient.se">
													수정</button>
												<button type="button" class="store_info_ingredient_view_btn"
													data-ing-itemNumber="${ing.itemNumber}"
