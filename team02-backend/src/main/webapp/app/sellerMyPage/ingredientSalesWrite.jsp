  ...
  <div class="ingredientsalewrite_submit_table">
    ...
    <div class="form-group photo-vertical">
      ...
      <div class="photo-upload">
        <label for="file" class="image-label ingredientsaleswrite_small_label">메뉴 사진</label>
...
<!-- //음식 사진 등록 끝 -->
				...
				<div class="ingredientsaleswrite_box">
					<label for="ingredientsaleswrite_menu" class="ingredientsaleswrite_small_label">메뉴명</label> 
					<input
				...
				<div class="ingredientsaleswrite_box">
					<label for="ingredientsaleswrite_explain" class="ingredientsaleswrite_small_label">음식 설명</label>
				...
				<div class="ingredientsaleswrite_box">
					<label for="ingredientsaleswrite_expiry" class="ingredientsaleswrite_small_label">소비기한</label> 
					<input
