...
<head>
  ...
  <link rel="stylesheet" href="./../../assets/css/sellerMyPage/sellerMyCommentsList.css">
  <link rel="stylesheet" href="./../../assets/css/header.css">
  <link rel="stylesheet" href="./../../assets/css/footer.css">
  <script defer src="./../../assets/js/sellerMyPage/sellerMyCommentsList.js"></script>
  <script>
  ...
  <main>
    ...
    <div class="seller_mycomments_menu">
      ...
      <ul class="seller_mycomments_menu_list">
        ...
        <li class="seller_mycomments_menu_list_current"><a href="./../sellerMyPage/sellerMyCommentsList.html">내 댓글
            관리</a></li>
    ...
    <div class="seller_mycomments_page">
      ...
      <div>
        ...
        <div class="seller_mycomments_comments_list">
          <div class="seller_mycomments_sort"><a href="./../../app/community/freeBoardList.html">자유게시판</a></div>
          <div class="seller_mycomments_tag">[잡담]</div>
          <div class="seller_mycomments_title"><a href="./../../app/community/viewOwnPost.html">여기 개맛있음</a></div>
          <div class="seller_mycomments_comments_info">맛집ㅇㅈ</div>
          <div class="seller_mycomments_date">2505-08-01</div>
          <div class="seller_mycomments_like_count">1</div>
        </div>
        <div class="seller_mycomments_comments_list">
          <div class="seller_mycomments_sort"><a href="./../../app/community/recipeList.html">레시피공유</a></div>
          <div class="seller_mycomments_tag">[베이커리]</div>
          <div class="seller_mycomments_title"><a href="./../../app/community/viewOwnPost.html">기수바게트 만들기</a></div>
          <div class="seller_mycomments_comments_info">기수바게트 개꿀맛</div>
          <div class="seller_mycomments_date">2505-08-04</div>
          <div class="seller_mycomments_like_count">3</div>
        </div>
      </div>
