...
<head>
  ...
  <script defer src="./../../assets/js/sellerMyPage/salesHistoryList.js"></script>
  <script>
  ...
  <main>
    ...
    <div class="sale_history_menu">
      ...
      <ul class="sale_history_menu_list">
        ...
        <li class="sale_history_menu_list_current"><a href="./../sellerMyPage/todaySaleList.html">판매 내역</a></li>
      </ul>
    </div>
