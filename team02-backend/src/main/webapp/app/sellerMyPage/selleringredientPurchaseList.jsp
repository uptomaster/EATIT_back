...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/sellerMyPage/selleringredientPurchseList.css">
  <!-- 파비콘 -->
  ...
  <main>
    ...
    <div class="seller_ingredient_purchase_menu">
      ...
      <ul class="seller_ingredient_purchase_menu_list">
				...
				<li class="store_info_menu_list_current"><a href="${pageContext.request.contextPath}/sellerMyPage/buiedIngredient.se">재료 구매 내역</a></li>
