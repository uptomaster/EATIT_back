...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/sellerMyPage/foodSalesWrite.css">
<!-- 파비콘 -->
...
<script defer
	src="${pageContext.request.contextPath}/assets/js/sellerMyPage/foodSalesWrite.js"></script>
...
<body>
	...
	<main>
		...
		<div class="foodsaleswrite_container">
			<!-- 1100px 영역-->
			<form
				action="${pageContext.request.contextPath}/sellerMyPage/addFoodOk.se"
				method="post" enctype="multipart/form-data"
				class="foodsaleswrite_content_container">
				<!-- 컨텐츠 영역 -->
				<div class="foodsaleswrite_title">음식 판매 등록</div>
				<!-- 음식 정보 등록 -->
				<!-- 음식 사진 등록 -->
