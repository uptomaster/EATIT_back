...
<head>
  ...
  <link rel="stylesheet" href="./../../assets/css/admin/noticeList.css">
        ...
        <div class="admin_list_whitebox">
          ...
          <ul class="admin_list_valuebox">
            <li class="admin_list_value">
              ...
              <a href="./../../app/admin/noticeDetail.html" class="admin_list_userid_link"><p id="admin_list_title_value" class="admin_list_row">[공지] 밥세권 이용안내</p></a>
