...
<head>
  ...
  <script defer src="${pageContext.request.contextPath}/assets/js/admin/boardFreeList.js"></script>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/boardFreeList.css">
  <link rel="stylesheet"
      ...
      <div class="admin_listwrapper">
        ...
        <div class="admin_pagenation_search">
          <div class="admin_pagenation">
            <c:if test="${prev}">
              <li>
                <a href="${pageContext.request.contextPath}/admin/boardFree/list.ad?page=${startPage-1}" class="prev">&lt;</a>
              </li>
            </c:if>
            <c:forEach var="i" begin="${startPage}" end="${endPage}">
              <c:choose>
                ...
                <c:otherwise>
                  <li>
                    <a href="${pageContext.request.contextPath}/admin/boardFree/list.ad?page=${i}">
                      <c:out value="${i}" />
                    </a>
                  </li>
                </c:otherwise>
            ...
            <c:if test="${next}">
              <li>
                <a href="${pageContext.request.contextPath}/admin/boardFree/list.ad?page=${endPage+1}" class="next">&gt;</a>
              </li>
            </c:if>
          </div>

          <!-- 검색 -->
          <form action="${pageContext.request.contextPath}/admin/boardFree/list.ad" method="get">
