...
<head>
  ...
  <script defer src="./../../assets/js/admin/boardFreeList.js"></script>
  <link rel="stylesheet" href="./../../assets/css/admin/boardFreeList.css">
    ...
    <main class="admin_inner">
      ...
      <div class="admin_listwrapper">
        ...
        <div class="admin_list_whitebox">
          ...
          <ul class="admin_list_valuebox">
            <li class="admin_list_value">
              ...
              <a href="./../../app/admin/boardFreeDetail.html" class="admin_list_userid_link"><p id="admin_list_title_value" class="admin_list_row">[잡담] 1빠요 ㅋㅋ[1]</p></a>
              <a href="./../../app/admin/memberDetail.html" class="admin_list_memaber_link"><p id="admin_list_userid_value" class="admin_list_row"><img class="grade_icon" src="./../../assets/img/나무.png" alt="">gisu</p></a>
              <p id="admin_list_date_value" class="admin_list_row">25-08-03</p>
              <p id="admin_list_views_value" class="admin_list_row">12</p>
        ...
        <div class="admin_pagenation_search">
          <button id="prepare_notice_btn" type="button">공지작성</button>
