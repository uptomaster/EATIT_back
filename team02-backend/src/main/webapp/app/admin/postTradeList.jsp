        ...
        <div class="admin_list_whitebox">
          ...
          <ul class="admin_list_valuebox">
            <li class="admin_list_value">
              ...
              <a href="./../../app/admin/postTradeDetail.html" class="admin_list_userid_link"><p id="admin_list_title_value" class="admin_list_row">남는 양파 팔아요 @@</p></a>
              <p id="admin_list_shopname_value" class="admin_list_row">맛있는 고기집</p>
              <p id="admin_list_sellcase_value" class="admin_list_row">재료</p>
              <a href="./../../app/admin/memberDetail.html" class="admin_list_userid_link"><p id="admin_list_userid_value" class="admin_list_row"><img class="grade_icon" src="./../../assets/img/씨앗.png" alt="">gogi</p></a>
