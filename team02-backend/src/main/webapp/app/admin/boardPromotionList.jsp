...
<script defer
	src="${pageContext.request.contextPath}/assets/js/admin/boardPromotionList.js"></script>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/admin/boardPromotionList.css">
<link rel="stylesheet"
			...
			<div class="admin_listwrapper">
				...
				<div class="admin_pagenation_search">
					...
					<ul class="admin_pagenation">
						<c:if test="${prev}">
							<li><a
								href="${pageContext.request.contextPath}/admin/boardPromotion/list.ad?page=${startPage-1}"
								class="prev">&lt;</a></li>
						</c:if>
						<c:forEach var="i" begin="${startPage}" end="${endPage}">
							<c:choose>
								...
								<c:otherwise>
									<li><a
										href="${pageContext.request.contextPath}/admin/boardPromotion/list.ad?page=${i}">${i}</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						<c:if test="${next}">
							<li><a
								href="${pageContext.request.contextPath}/admin/boardPromotion/list.ad?page=${endPage+1}"
								class="next">&gt;</a></li>
						</c:if>
					</ul>
