      ...
      <div class="admin_listwrapper">
        <div class="admin_whitebox">
          ...
          <div class="admin_post_titlebox">
            <span class="admin_post_tag">[공지/이벤트]</span>
            <img src="${pageContext.request.contextPath}/assets/img/관리자.png" alt="관리자" class="admin_post_icon">
            <span class="admin_post_userid">${notice.adminId}</span>
            <span class="admin_post_title">${notice.postTitle}</span>
            <span class="admin_post_date">(${notice.postCreatedDate})</span>
            <span class="admin_post_view"><label>조회:</label> ${notice.postViewCount}</span>
            <span class="admin_post_like"><label>추천:</label> ${notice.postLikeCount}</span>
          </div>
          ...
          <c:if test="${not empty images}">
            <div class="admin_post_images">
              <c:forEach var="img" items="${images}">
                <img src="${pageContext.request.contextPath}/upload/${img.adminImageSystemName}"
          ...
          <div class="admin_detail_buttons">
            <!-- 수정 -->
            <form action="${pageContext.request.contextPath}/admin/notice/edit.ad" method="get">
              <input type="hidden" name="postNumber" value="${notice.postNumber}">
              <button type="submit" id="admin_updatebtn">수 정</button>
            </form>

            <!-- 삭제 -->
            <form action="${pageContext.request.contextPath}/admin/notice/deleteOk.ad"
            ...
            <!-- 목록 -->
            <a href="${pageContext.request.contextPath}/admin/notice/list.ad" id="admin_listbtn">목 록</a>
          </div>
