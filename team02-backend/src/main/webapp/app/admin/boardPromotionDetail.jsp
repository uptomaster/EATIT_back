...
<script defer
	src="${pageContext.request.contextPath}/assets/js/admin/boardPromotionDetail.js"></script>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/admin/boardPromotionDetail.css">
<link rel="stylesheet"
				...
				<div class="admin_whitebox">
					...
					<div class="admin_post_titlebox">
						<div class="admin_post_userid">
							<p>${promotionDetail.memberId}</p>
						</div>
						<div class="admin_post_title">
							<p>${promotionDetail.postTitle}</p>
						</div>
						<div class="admin_post_date">
							<p>(${promotionDetail.postCreatedDate})</p>
						</div>
						<div class="admin_post_view">
							<label>조회 :</label>${promotionDetail.postViewCount}</div>
						<div class="admin_post_like">
							<label>추천 :</label>${promotionDetail.postLikeCount}</div>
					</div>

					<!-- 게시글 내용 -->
					<div class="admin_post_content">
						<p>
							<c:out value="${promotionDetail.promoContent}" />
						</p>
					</div>
					...
					<div class="admin_detail_buttons">
						...
						<!-- 목록 -->
						<a href="${pageContext.request.contextPath}/admin/boardPromotion/list.ad" id="admin_listbtn">목 록</a>
					</div>
