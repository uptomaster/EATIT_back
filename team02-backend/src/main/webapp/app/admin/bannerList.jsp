...
<head>
  ...
  <script defer src="./../../assets/js/admin/bannerList.js"></script>
  <link rel="stylesheet" href="./../../assets/css/admin/bannerList.css">
    ...
    <main class="admin_inner">
      ...
      <div class="admin_listwrapper">
        <div class="admin_list_title">
          <ul class="admin_list">
            <a href="">
              <li id="admin_list_menu_banner" class="admin_list_menu">배너/광고</li>
            </a>
          </ul>
        </div>
        <div class="admin_list_whitebox">
          <div class="admin_list_namebox">
            ...
            <ul class="admin_list_name">
              ...
              <li id="admin_list_title" class="admin_list_row">배너 제목</li>
              <li id="admin_list_userid" class="admin_list_row">아이디</li>
              <li id="admin_list_date" class="admin_list_row">게시일</li>
              <li id="admin_list_views" class="admin_list_row">마감일</li>
            </ul>
          </div>        
          <!-- 글 목록 행 -->
          <ul class="admin_list_valuebox">
            <li class="admin_list_value">
              ...
              <a href="./../../app/admin/bannerDetail.html" class="admin_list_userid_link"><p id="admin_list_title_value" class="admin_list_row">브런치 먹어요</p></a>
              ...
              <p id="admin_list_views_value" class="admin_list_row">25-08-16</p>
            </li>
          </ul>
        </div> 
        <!-- 페이지네이션, 검색창 -->
        <div class="admin_pagenation_search">
          <button id="prepare_notice_btn" type="button" onclick="">작성하기</button>
