...
<head>
  ...
  <script defer src="./../../assets/js/admin/suspendedMemberList.js"></script>
  <link rel="stylesheet" href="./../../assets/css/admin/suspendedMemberList.css">
        ...
        <div class="admin_list_whitebox">
          <div class="admin_list_namebox">
            ...
            <ul class="admin_list_name">
              ...
              <li id="admin_list_startDate" class="admin_list_row">정지시작일</li>
              <li id="admin_list_endDate" class="admin_list_row">정지종료일</li>
            </ul>
          </div>        
          <!-- 글 목록 행 -->
          <ul class="admin_list_valuebox">
            <li class="admin_list_value">
              ...
              <p id="admin_list_warning_value" class="admin_list_row">2</p>
              <p id="admin_list_startDate_value" class="admin_list_row">25-08-09 23:32:03</p>            
              <p id="admin_list_endDate_value" class="admin_list_row">25-08-12 23:32:02</p>           
            </li>
          </ul>
        </div> 
        <!-- 페이지네이션, 검색창 -->
