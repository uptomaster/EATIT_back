...
<head>
  ...
  <script defer src="${pageContext.request.contextPath}/assets/js/admin/boardRecipeDetail.js"></script>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/boardRecipeDetail.css">
  <link rel="stylesheet"
      ...
      <div class="admin_listwrapper">
        <div class="admin_whitebox">
          ...
          <div class="admin_post_titlebox">
            <div class="admin_post_userid"><p>${recipeDetail.memberId}</p></div>
            <div class="admin_post_title"><p>${recipeDetail.postTitle}</p></div>
            <div class="admin_post_date"><p>(${recipeDetail.postCreatedDate})</p></div>
            <div class="admin_post_view"><label>조회 :</label>${recipeDetail.postViewCount}</div>
            <div class="admin_post_like"><label>추천 :</label>${recipeDetail.postLikeCount}</div>
          </div>

          <!-- 게시글 내용 -->
          <div class="admin_post_content">
            <p><c:out value="${recipeDetail.recipeContent}" /></p>
          </div>
