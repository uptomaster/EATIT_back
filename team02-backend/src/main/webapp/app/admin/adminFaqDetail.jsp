...
<head>
  ...
  <script defer src="./../../assets/js/admin/adminCustromerServiceDetail.js"></script>
  <link rel="stylesheet" href="./../../assets/css/admin/adminCustromerServiceDetail.css">
    ...
    <div class="admin_inner">
      ...
      <div class="admin_listwrapper">
        ...
        <div class="admin_whitebox">
          ...
          <!-- 게시글 내용 -->
          <div class="admin_post_content"><p>바로옆에 고객문의는 무너졌냐?</p></div>
        </div>
        <!-- 하단 버튼 영역 -->
