...
<head>
  <meta charset="UTF-8">
  <title>공지 수정</title>
  <script defer src="${pageContext.request.contextPath}/assets/js/admin/noticeEdit.js"></script>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/noticeEdit.css">
  <link rel="stylesheet"
    ...
    <main class="admin_inner">
      ...
      <div class="admin_listwrapper">
        <div class="admin_whitebox">
          <!-- 수정 폼 -->
          <form action="${pageContext.request.contextPath}/admin/notice/updateOk.ad"
            ...
            <div class="admin_notice_titlebox">
              ...
              <input type="text" id="postTitle" name="postTitle"
                     value="${notice.postTitle}" required />
            </div>
            ...
            <div class="bottom_btn_area">
              ...
              <button type="button" id="admin_notice_cancelbtn"
