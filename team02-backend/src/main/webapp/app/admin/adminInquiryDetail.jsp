...
<title>고객문의 상세</title>
<script defer
	src="${pageContext.request.contextPath}/assets/js/admin/adminInquiryDetail.js"></script>
<link rel="stylesheet"
				...
				<div class="admin_whitebox">
					...
					<div class="admin_post_titlebox">
						...
						<div class="admin_post_userid">
							<p>${inquiry.memberName}</p>
						</div>
						<div class="admin_post_title">
							<p>${inquiry.postTitle}</p>
						</div>
						<div class="admin_post_date">
							<p>(${inquiry.postCreatedDate})</p>
						</div>
						<div class="admin_post_status">
							<span id="post_status_text"> <c:choose>
					...
					<div class="admin_post_content">
						<p>
							<c:out value="${inquiry.inquiryContent}" />
						</p>
					</div>
					...
					<div class="admin_reply_section">
						...
						<c:choose>
							...
							<c:otherwise>
								<form id="reply_form" class="reply_form" method="post"
									...
									<input type="hidden" name="postNumber"
										value="${inquiry.postNumber}">
									<textarea id="reply_text" name="replyContent"
						...
						<c:if test="${inquiry.inquiryStatus ne 'COMPLETE'}">
							<form
								action="${pageContext.request.contextPath}/admin/inquiry/updateStatus.ad"
								method="post" onsubmit="return confirm('답변을 완료 처리하시겠습니까?');">
								<input type="hidden" name="postNumber"
									value="${inquiry.postNumber}"> <input type="hidden"
									name="inquiryStatus" value="COMPLETE">
