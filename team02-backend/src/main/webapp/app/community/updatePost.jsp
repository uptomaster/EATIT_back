...
<script defer
	src="${pageContext.request.contextPath}/assets/js/community/updatePost.js"></script>
<script defer
...
<body>
	...
	<main class="layout">
		...
		<section class="container">
			...
			<form action="${pageContext.request.contextPath}/community/postUpdateOk.co"
