...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/community/recipeList.css" />
  ...
  <script defer src="${pageContext.request.contextPath}/assets/js/community/recipeList.js"></script>
    ...
    <div class="main_container">
      ...
      <section class="community_list" aria-label="게시판 목록">
   					...
   					<c:forEach var="post" items="${postList}">
	   					 <div class="board-row list_row flex_row">
	   					 	...
	   					 	<div class="board-item col_title">
	   					 		<a href="${pageContext.request.contextPath}/community/recipeListOk.co?postNumber=${post.postNumber}">
        ...
        <%-- <div id="postListBody" class="list_body" role="rowgroup">
          ...
          <div class="list_row flex_row" role="row">
            <div class="col_title" role="cell"><a href="${pageContext.request.contextPath}/community/viewOtherPost.jsp">크림 파스타 완벽 가이드</a>
            </div>
            <div class="col_author" role="cell">
              LionelMessi
          ...
          <div class="list_row flex_row" role="row">
            <div class="col_title" role="cell"><a href="${pageContext.request.contextPath}/community/viewOtherPost.jsp">짜장면 집에서 쉽게 만들기</a>
            </div>
            <div class="col_author" role="cell">
              CristianoRonaldo
          ...
          <div class="list_row flex_row" role="row">
            <div class="col_title" role="cell"><a href="${pageContext.request.contextPath}/community/viewOtherPost.jsp">초밥 만들기 초보 가이드</a>
            </div>
            <div class="col_author" role="cell">
              NeymarJr
          ...
          <div class="list_row flex_row" role="row">
            <div class="col_title" role="cell"><a href="${pageContext.request.contextPath}/community/viewOtherPost.jsp">초코 케이크 레시피</a></div>
            <div class="col_author" role="cell">
              KylianMbappe
