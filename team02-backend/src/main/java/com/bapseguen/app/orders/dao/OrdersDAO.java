...
/**
 * Mapper namespace: "orders" - orders.insertOrder - orders.selectOrder -
 * orders.selectOrdersByMember - orders.updateOrderStatus - orders.deleteOrder -
 * orders.insertOrderItem - orders.selectOrderItems -
 * orders.updateOrderPaymentInfo - orders.selectOrderByOrderId (편의)
 */
