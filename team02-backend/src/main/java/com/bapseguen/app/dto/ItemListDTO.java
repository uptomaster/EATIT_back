...
//	private String itemImageOriginalName;
	...
	public ItemImageDTO getImg() {
		return img;
	}
	public void setImg(ItemImageDTO img) {
		this.img = img;
	}
	...
	public String toString() {
		return "ItemListDTO [itemNumber=" + itemNumber + ", businessNumber=" + businessNumber + ", itemType=" + itemType
				...
				+ ", businessName=" + businessName + ", img=" + img + "]";
	}

	/*
	 * public int getItemImageNumber() { return itemImageNumber; } public void
	 * setItemImageNumber(int itemImageNumber) { this.itemImageNumber =
	 * itemImageNumber; } public String getItemImageSystemName() { return
	 * itemImageSystemName; } public void setItemImageSystemName(String
	 * itemImageSystemName) { this.itemImageSystemName = itemImageSystemName; }
	 * public String getItemImageOriginalName() { return itemImageOriginalName; }
