...
public class AdminPostDTO {
	...
	private String postType; // 게시글 타입 (NOTICE / FAQ)
	...
	public String toString() {
		return "AdminPostDTO{" + "postNumber=" + postNumber + ", postTitle='" + postTitle + '\'' + ", postLikeCount="
				...
				+ ", postDeleteState='" + postDeleteState + '\'' + ", postCreatedDate='" + postCreatedDate + '\''
				+ ", postUpdatedDate='" + postUpdatedDate + '\'' + ", postType='" + postType + '\'' + ", adminNumber="
				+ adminNumber + ", adminId='" + adminId + '\'' + ", adminTreeGrade='" + adminTreeGrade + '\''
				+ ", noticeContent='" + noticeContent + '\'' + ", faqContent='" + faqContent + '\'' + ", images="
				+ images + '}';
	}
}
