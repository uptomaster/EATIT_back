...
public class FaqReadOkController implements Execute{

	@Override
	public Result execute(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
			
			System.out.println("====FaqReadOkOkController 실행====");
...
//			}
			...
			//DB에서 게시글 가져오기
			FaqDTO faqDTO = communityDAO.selectFaqDetail(postNumber);
			...
			request.setAttribute("post", faqDTO);
			result.setPath("/app/community/viewOwnFaqPost.jsp");
			...
			//null값확인
			System.out.println("제목: " + faqDTO.getPostTitle());
			System.out.println("작성일: " + faqDTO.getPostCreatedDate());
