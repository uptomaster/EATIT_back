...
public class MyPostListOkController implements Execute{

	@Override
	public Result execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

		System.out.println("====MyPostListOkController 실행====");
        ...
        int rowCount = 10;  // 한 페이지에 보여줄 글 개수
        ...
        // 게시글 목록 조회
        List<PostDetailDTO> myPosts = userMyPageDAO.myPostSelect(pageMap);
        request.setAttribute("myPosts", myPosts);

        // 전체 게시글 수
        int total = userMyPageDAO.getMyPostCount(memberNumber);
        ...
        result.setPath("/app/userMyPage/manageMyPostsList.jsp");
