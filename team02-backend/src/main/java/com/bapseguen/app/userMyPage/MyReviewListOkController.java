...
public class MyReviewListOkController implements Execute{

	@Override
	public Result execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

		System.out.println("====MyReviewListOkController 실행====");
        ...
        result.setPath("/app/userMyPage/manageMyReviewsList.jsp");
